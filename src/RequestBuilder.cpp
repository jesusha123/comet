...
std::unique_ptr<Request> RequestBuilder::buildRequest(std::unique_ptr<Ui::RequestWidget>& ui)
{
...
void RequestBuilder::addBody(std::unique_ptr<Ui::RequestWidget>& ui, std::unique_ptr<Request>& request)
{
...
void RequestBuilder::addRequestHeaders(std::unique_ptr<Ui::RequestWidget>& ui, std::unique_ptr<Request>& request)
{
