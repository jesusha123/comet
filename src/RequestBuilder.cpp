...
std::unique_ptr<Request> RequestBuilder::buildRequest()
{
...
void RequestBuilder::addBody(std::unique_ptr<Request>& request)
{
...
void RequestBuilder::addRequestHeaders(std::unique_ptr<Request>& request)
{
